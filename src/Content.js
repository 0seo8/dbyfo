                        ...
                        <div className="content">
                            ...
                            <div className="inner_container">
                                <div className="inner_content">
                                    {item.content}
                                    <div className="inner_footer"> Designer : Euiseok Kim, SeungCheol Lee, JunKy jung       Client : FIET</div>
                                </div>
                                <div className="inner_image" onClick={
                                    ...
                                    <div className="inner_image_footer"> Designer : Euiseok Kim, SeungCheol Lee, JunKy jung       Client : FIET</div>
                                </div>
